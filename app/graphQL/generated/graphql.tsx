...
export type GetCartItemsByAccountIdQueryVariables = Exact<{
    id: Scalars["ID"];
}>;

export type GetCartItemsByAccountIdQuery = {
    readonly __typename?: "Query";
    readonly account?: {
        readonly __typename?: "Account";
        readonly cart?: {
...
>;
export const GetCartItemsByAccountIdDocument = gql`
    query GetCartItemsByAccountId($id: ID!) {
        account(where: { id: $id }) {
            cart {
                ...cartContentQueryWithOption
            }
...
/**
 * __useGetCartItemsByAccountIdQuery__
 *
 * To run a query within a React component, call `useGetCartItemsByAccountIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCartItemsByAccountIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetCartItemsByAccountIdQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetCartItemsByAccountIdQuery(
    baseOptions: Apollo.QueryHookOptions<GetCartItemsByAccountIdQuery, GetCartItemsByAccountIdQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<GetCartItemsByAccountIdQuery, GetCartItemsByAccountIdQueryVariables>(
        GetCartItemsByAccountIdDocument,
        options
    );
}
export function useGetCartItemsByAccountIdLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<GetCartItemsByAccountIdQuery, GetCartItemsByAccountIdQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useLazyQuery<GetCartItemsByAccountIdQuery, GetCartItemsByAccountIdQueryVariables>(
        GetCartItemsByAccountIdDocument,
        options
    );
}
export type GetCartItemsByAccountIdQueryHookResult = ReturnType<typeof useGetCartItemsByAccountIdQuery>;
export type GetCartItemsByAccountIdLazyQueryHookResult = ReturnType<typeof useGetCartItemsByAccountIdLazyQuery>;
export type GetCartItemsByAccountIdQueryResult = Apollo.QueryResult<
