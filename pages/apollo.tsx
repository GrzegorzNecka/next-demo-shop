import { ApolloCache, UpdateQueryOptions } from "@apollo/client";
import { Main } from "components/main";
import { apolloClient } from "graphQL/apolloClient";
import { useQuery, gql } from "urql";
import { CounterContentFragmentDoc, GetCounterDocument, useGetCounterQuery } from "graphQL/generated/graphql";
...
const Apollo = () => {
    ...
    console.log("🚀 ~ file: index.tsx:19 ~ Home ~  data", data);
    ...
    const handleOnClick = async () => {
        ...
        if (result.status === 200) {
            ...
            console.log("🚀 ~ file: index.tsx:32 ~ handleOnClick ~ data", data.counter.data.updateTestCache.counter);
